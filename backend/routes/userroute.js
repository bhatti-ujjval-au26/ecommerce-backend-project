...
const { registerUser,loginUser,logout,forgotPassword,resetPassword,getUserDetails,updatePassword,
    updateProfile,getAllUsers,getSingleUser,updateUserRoal,deleteUser,} = require('../controller/usercontroller');
...
.put(isAuthenticatedUser,authorizeRoles('admin'),updateUserRoal)
